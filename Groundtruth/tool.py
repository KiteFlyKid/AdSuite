...
if __name__ == "__main__":
    ...
    df=pd.read_csv('UIExploration/data/task_df.csv')
    ...
    for idx,row in df.iterrows():
        ...
        trace_dir = Path("groundtruth") / package
        meta_dir=trace_dir / 'meta.json'
        if meta_dir.exists():
            continue

        # subprocess.run(f'adb install {apk_path}.apk', shell=True)
        # continue
        ...
        # controller.reinstall_app(row.pkg_name, apk_path)
