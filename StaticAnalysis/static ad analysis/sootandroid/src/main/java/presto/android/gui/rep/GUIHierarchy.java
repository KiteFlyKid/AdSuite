...
//    public View parent;
    ...
    public Set<String> title = Sets.newHashSet();
    //public String text;
//    public String title;
    public Set<String> hint = Sets.newHashSet();
    ...
    public String toParentString(){
      View parent=getParentWithIdName();
    ...
    public View getParentWithIdName() {
      // Check if this view's idName is not "NO_ID", indicating this view itself has a valid ID
      if (!this.idName.equals("NO_ID")) {
        return this; // Return this view as it has a valid ID
      } else {
        // If this view's idName is "NO_ID" and it has a parent, ask the parent
        if (this.parent != null) {
          return this.parent.getParentWithIdName();
        } else {
          // No parent to check, and this view's idName is "NO_ID"
          return this; // No suitable parent found
        }
      }
    }
